...
func GetForwardMessage(ctx *rosm.Ctx, id string) gjson.Result {
	rsp := CallAction(ctx, "get_forward_msg", zero.Params{
		"id": id,
	}).Data
	return rsp
}
...
func SendLike(ctx *rosm.Ctx, userID int64, times int) {
	CallAction(ctx, "send_like", zero.Params{
		"user_id": userID,
		"times":   times,
	})
}
...
func SetGroupKick(ctx *rosm.Ctx, groupID, userID int64, rejectAddRequest bool) {
	CallAction(ctx, "set_group_kick", zero.Params{
		"group_id":           groupID,
		"user_id":            userID,
...
func SetGroupBan(ctx *rosm.Ctx, groupID, userID, duration int64) {
	CallAction(ctx, "set_group_ban", zero.Params{
		"group_id": groupID,
		"user_id":  userID,
		"duration": duration,
	})
...
func SetGroupWholeBan(ctx *rosm.Ctx, groupID int64, enable bool) {
	CallAction(ctx, "set_group_whole_ban", zero.Params{
		"group_id": groupID,
		"enable":   enable,
	})
}
...
func SetGroupAdmin(ctx *rosm.Ctx, groupID, userID int64, enable bool) {
	CallAction(ctx, "set_group_admin", zero.Params{
		"group_id": groupID,
		"user_id":  userID,
		"enable":   enable,
	})
...
func SetGroupAnonymous(ctx *rosm.Ctx, groupID int64, enable bool) {
	CallAction(ctx, "set_group_anonymous", zero.Params{
		"group_id": groupID,
		"enable":   enable,
	})
}
...
func SetGroupCard(ctx *rosm.Ctx, groupID, userID int64, card string) {
	CallAction(ctx, "set_group_card", zero.Params{
		"group_id": groupID,
		"user_id":  userID,
		"card":     card,
	})
...
func SetGroupName(ctx *rosm.Ctx, groupID int64, groupName string) {
	CallAction(ctx, "set_group_name", zero.Params{
		"group_id":   groupID,
...
func SetGroupLeave(ctx *rosm.Ctx, groupID int64, isDismiss bool) {
	CallAction(ctx, "set_group_leave", zero.Params{
		"group_id":   groupID,
...
func SetGroupSpecialTitle(ctx *rosm.Ctx, groupID, userID int64, specialTitle string) {
	CallAction(ctx, "set_group_special_title", zero.Params{
		"group_id":      groupID,
		"user_id":       userID,
...
func SetFriendAddRequest(ctx *rosm.Ctx, flag string, approve bool, remark string) {
	CallAction(ctx, "set_friend_add_request", zero.Params{
		"flag":    flag,
		"approve": approve,
		"remark":  remark,
	})
...
func SetGroupAddRequest(ctx *rosm.Ctx, flag string, subType string, approve bool, reason string) {
	CallAction(ctx, "set_group_add_request", zero.Params{
		"flag":     flag,
		"sub_type": subType,
		"approve":  approve,
		"reason":   reason,
...
func GetLoginInfo(ctx *rosm.Ctx) gjson.Result {
	return CallAction(ctx, "get_login_info", zero.Params{}).Data
}
...
func GetStrangerInfo(ctx *rosm.Ctx, userID int64, noCache bool) gjson.Result {
	return CallAction(ctx, "get_stranger_info", zero.Params{
		"user_id":  userID,
		"no_cache": noCache,
	}).Data
}
...
func GetFriendList(ctx *rosm.Ctx) gjson.Result {
	return CallAction(ctx, "get_friend_list", zero.Params{}).Data
}
...
func GetGroupInfo(ctx *rosm.Ctx, groupID int64, noCache bool) zero.Group {
	rsp := CallAction(ctx, "get_group_info", zero.Params{
		"group_id": groupID,
		"no_cache": noCache,
	}).Data
	group := zero.Group{}
...
func GetGroupList(ctx *rosm.Ctx) gjson.Result {
	return CallAction(ctx, "get_group_list", zero.Params{}).Data
}
...
func GetGroupMemberInfo(ctx *rosm.Ctx, groupID int64, userID int64, noCache bool) gjson.Result {
	return CallAction(ctx, "get_group_member_info", zero.Params{
		"group_id": groupID,
		"user_id":  userID,
		"no_cache": noCache,
	}).Data
...
func GetGroupMemberList(ctx *rosm.Ctx, groupID int64) gjson.Result {
	return CallAction(ctx, "get_group_member_list", zero.Params{
		"group_id": groupID,
	}).Data
}
...
func GetGroupHonorInfo(ctx *rosm.Ctx, groupID int64, hType string) gjson.Result {
	return CallAction(ctx, "get_group_honor_info", zero.Params{
		"group_id": groupID,
		"type":     hType,
	}).Data
}
...
func GetRecord(ctx *rosm.Ctx, file string, outFormat string) gjson.Result {
	return CallAction(ctx, "get_record", zero.Params{
		"file":       file,
...
func GetImage(ctx *rosm.Ctx, file string) gjson.Result {
	return CallAction(ctx, "get_image", zero.Params{
		"file": file,
	}).Data
}
...
func GetVersionInfo(ctx *rosm.Ctx) gjson.Result {
	return CallAction(ctx, "get_version_info", zero.Params{}).Data
}
...
func SetGroupPortrait(ctx *rosm.Ctx, groupID int64, file string) {
	CallAction(ctx, "set_group_portrait", zero.Params{
		"group_id": groupID,
		"file":     file,
	})
}
...
func OCRImage(ctx *rosm.Ctx, file string) gjson.Result {
	return CallAction(ctx, "ocr_image", zero.Params{
		"image": file,
	}).Data
}
...
func GetGroupSystemMessage(ctx *rosm.Ctx) gjson.Result {
	return CallAction(ctx, "get_group_system_msg", zero.Params{}).Data
}
...
func MarkMessageAsRead(ctx *rosm.Ctx, messageID int64) zero.APIResponse {
	return CallAction(ctx, "mark_msg_as_read", zero.Params{
		"message_id": messageID,
	})
}
...
// https://github.com/Mrs4s/go-cqhttp/blob/master/docs/cqhttp.md#%E6%A0%87%E8%AE%B0%E6%B6%88%E6%81%AF%E5%B7%B2%E8%AF%BB
func MarkThisMessageAsRead(ctx *rosm.Ctx) zero.APIResponse {
	return CallAction(ctx, "mark_msg_as_read", zero.Params{
...
func GetOnlineClients(ctx *rosm.Ctx, noCache bool) gjson.Result {
	return CallAction(ctx, "get_online_clients", zero.Params{
		"no_cache": noCache,
	}).Data
}
...
func GetGroupAtAllRemain(ctx *rosm.Ctx, groupID int64) gjson.Result {
	return CallAction(ctx, "get_group_at_all_remain", zero.Params{
		"group_id": groupID,
	}).Data
}
...
func GetGroupMessageHistory(ctx *rosm.Ctx, groupID, messageID int64) gjson.Result {
	return CallAction(ctx, "get_group_msg_history", zero.Params{
		"group_id":    groupID,
...
func GetGroupEssenceMessageList(ctx *rosm.Ctx, groupID int64) gjson.Result {
	return CallAction(ctx, "get_essence_msg_list", zero.Params{
		"group_id": groupID,
	}).Data
}
...
func SetGroupEssenceMessage(ctx *rosm.Ctx, messageID int64) zero.APIResponse {
	return CallAction(ctx, "set_essence_msg", zero.Params{
		"message_id": messageID,
	})
}
...
func DeleteGroupEssenceMessage(ctx *rosm.Ctx, messageID int64) zero.APIResponse {
	return CallAction(ctx, "delete_essence_msg", zero.Params{
		"message_id": messageID,
	})
}
...
func GetWordSlices(ctx *rosm.Ctx, content string) gjson.Result {
	return CallAction(ctx, ".get_word_slices", zero.Params{
		"content": content,
	}).Data
}
...
func SendGuildChannelMessage(ctx *rosm.Ctx, guildID, channelID string, message interface{}) string {
	rsp := CallAction(ctx, "send_guild_channel_msg", zero.Params{
		"guild_id":   guildID,
...
func UploadGroupFile(ctx *rosm.Ctx, groupID int64, file, name, folder string) zero.APIResponse {
	return CallAction(ctx, "upload_group_file", zero.Params{
		"group_id": groupID,
		"file":     file,
		"name":     name,
		"folder":   folder,
